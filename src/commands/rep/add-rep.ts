...
import { sendFinalMessages } from "../../utils/finalwares/sendFinalMessages.ts";
...
export default {
	...
	execute: composeMiddlewares(
		[verifyIsGuild(process.env.GUILD_ID ?? ""), verifyHasRoles(getRoles("staff", "repatidorDeRep"))],
			...
			return {
				...
				finalMessages: [
					...
					},
					{
						...
						content: `✅ se le ha dado un rep al usuario: \`${user.tag}\``,
					},
				],
			};
		},
		[updateRepRoles, sendFinalMessages]
	),
};
