...
export default {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                .setName("lenguaje")
                .setDescription("Lenguaje utilizado")
        )
        .addStringOption((option) =>
            option
                .setName("codigo")
                .setDescription("Código para analizar")
        )
        ...
        async (interaction: IPrefixChatInputCommand): Promise<PostHandleable | void> => {
            ...
            try {
                ...
                embed
                    .setColor(COLORS.errRed)
                    .setTitle("Error")
                    .setDescription(`Fallo al compilar: ${error.message}`);
            }

            await initialReply.edit({ embeds: [embed] });
        },
    ),
    prefixResolver: (client: ExtendedClient) => new PrefixChatInputCommand(client, "compile",
        [
            {
                name: "lenguaje",
                required: false,
