...
export default {
	...
	execute: composeMiddlewares(
		...
		async (interaction: ChatInputCommandInteraction): Promise<PostHandleable | void> => {
			...
			if (amount < 1 || amount > 4000 || amount > userData.cash) return await replyError(interaction, `Se ingresó una cantidad inválida, debe ser ${amount < 100 ? "mayor que 100" : "menor que 500"} o no tienes suficiente dinero`);
